...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($_POST['parceiro_id'])) {
        $where[] = 'e.parceiro_id = :parceiro_id';
        $params[':parceiro_id'] = $_POST['parceiro_id'];
    }
    ...
    <div class="card-body">
        ...
        <form id="formRelatorioEntradas" class="row g-3 mb-4">
            ...
            <div class="col-md-3">
                ...
                <select name="parceiro_id" class="form-select">
                    <option value="">Todos</option>
                    <?php foreach ($parceiros as $pa): ?>
                        <option value="<?= $pa['parceiro_id'] ?>">
                            <?= htmlspecialchars($pa['nome']) ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            </div>
