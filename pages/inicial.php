...
$caminhoFoto = file_exists($_SERVER['DOCUMENT_ROOT'] . '/Controller/uploads/usuarios/' . $fotoUsuario)
    ? '/Controller/uploads/usuarios/' . $fotoUsuario
    : '/Controller/uploads/usuarios/';
?>
...
<body>
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex align-items-center">
                ...
                <button
                    ...
                    <img id="fotoUsuario_1"
                        src="/Controller/uploads/usuarios/usuario_<?= $_SESSION['usuario_id'] ?>.jpg"
    ...
    <script>
        ...
        document.getElementById('inputFoto').addEventListener('change', function () {
            ...
            fetch('/Controller/uploads/upload_foto.php', {
                method: 'POST',
                body: formData
            })
                .then(res => res.json())
