...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container-fluid">
      <a class="navbar-brand fw-bold" href="#">Lemyx</a>
      <div class="ms-auto">
        <button class="btn btn-outline-light" data-bs-toggle="modal" data-bs-target="#configModal">⚙️
    ...
    <div class="row w-100">
      ...
      <div class="col-md-4 right-side">
        <form class="login-form" method="POST" action="index.php">
          ...
          <?php if (isset($erro))
            echo "<p class='text-danger mt-2'>$erro</p>"; ?>
        </form>
      </div>
    </div>
  </div>
